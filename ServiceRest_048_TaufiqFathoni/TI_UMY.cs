...
namespace ServiceRest_048_TaufiqFathoni
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=UKNOWN\\SQLEXPRESS;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=fathoni123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlCommand com = new SqlCommand(query, sqlcon); //yg dikirim ke sql
